...
class Utility {
  ...
  static async retrieveFields() {
    const crmInfo = await db.query(faunadb_1.default.Select([ 'data', 'value' ], faunadb_1.default.Get(faunadb_1.default.Match(faunadb_1.default.Index('resource_by_name'), 'crm-tokens'))))
    return crmInfo.fields
  }

  static async saveFields(fields) {
    const crmInfo = await db.query(faunadb_1.default.Get(faunadb_1.default.Match(faunadb_1.default.Index('resource_by_name'), 'crm-tokens')))
