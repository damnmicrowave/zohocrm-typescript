...
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/fields/api_exception");
const fields_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/fields/fields_operations");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/fields/response_wrapper");
...
class Fields {
    ...
    static async getFields(moduleAPIName) {
        ...
        let fieldsOperations = new fields_operations_1.FieldsOperations(moduleAPIName);
