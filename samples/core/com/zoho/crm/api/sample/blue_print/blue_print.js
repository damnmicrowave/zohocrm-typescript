...
const blue_print_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/blue_print/blue_print_operations");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/blue_print/response_wrapper");
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/blue_print/api_exception");
const success_response_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/blue_print/success_response");
const blue_print_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/blue_print/blue_print");
const record_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/record/record");
const body_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/blue_print/body_wrapper");
class BluePrint {
    /**
     * <h3> Get Blueprint </h3>
    ...
    static async getBlueprint(moduleAPIName, recordId) {
        ...
        let bluePrintOperations = new blue_print_operations_1.BluePrintOperations(recordId, moduleAPIName);
                ...
                if (responseObject instanceof response_wrapper_1.ResponseWrapper) {
                    ...
                    transitions.forEach(async (transition) => {
                        ...
                        for (let field of fields) {
                            ...
                            let layout = await field.getLayouts();
