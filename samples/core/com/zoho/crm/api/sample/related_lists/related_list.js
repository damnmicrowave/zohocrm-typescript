...
exports.RelatedLists = void 0;
const related_lists_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/related_lists/related_lists_operations");
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/related_lists/api_exception");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/related_lists/response_wrapper");
class RelatedLists {
    /**
    ...
    static async getRelatedLists(moduleAPIName) {
        ...
        let relatedListsOperations = new related_lists_operations_1.RelatedListsOperations(moduleAPIName);
