...
const currencies_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/currencies_operations");
const currency_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/currency");
const success_response_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/success_response");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/response_wrapper");
const action_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/action_wrapper");
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/api_exception");
const format_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/format");
const body_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/body_wrapper");
const choice_1 = require("@zohocrm/typescript-sdk-2.0/utils/util/choice");
const base_currency_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/base_currency_wrapper");
const base_currency_action_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/currencies/base_currency_action_wrapper");
class Currencies {
    /**
    ...
    static async getCurrencies() {
        ...
        let currenciesOperations = new currencies_operations_1.CurrenciesOperations();
    ...
    static async enableMultipleCurrencies() {
        ...
        let request = new base_currency_wrapper_1.BaseCurrencyWrapper();
        //Get instance of Currency Class
        let currency = new currency_1.Currency();
        ...
        if (response !== null) {
            ...
            if (responseObject !== null) {
                ...
                if (responseObject instanceof base_currency_action_wrapper_1.BaseCurrencyActionWrapper) {
