...
const territories_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/territories/territories_operations");
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/territories/api_exception");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/territories/response_wrapper");
class Territories {
    /**
    ...
    static async getTerritories() {
        ...
        let territoriesOperations = new territories_operations_1.TerritoriesOperations();
