...
const query_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/query/query_operations");
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/query/api_exception");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/query/response_wrapper");
const body_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/query/body_wrapper");
class Query {
    static async getRecords() {
        //Get instance of QueryOperations Class
        let queryOperations = new query_operations_1.QueryOperations();
