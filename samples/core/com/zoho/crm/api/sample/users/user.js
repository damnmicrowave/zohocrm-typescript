...
const users_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/users_operations");
const success_response_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/success_response");
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/api_exception");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/response_wrapper");
const action_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/action_wrapper");
...
const role_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/roles/role");
const profile_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/profiles/profile");
const body_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/body_wrapper");
const request_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/request_wrapper");
class Users {
    /**
     * <h3> Get Users </h3>
    ...
    static async getUsers() {
        ...
        let usersOperations = new users_operations_1.UsersOperations();
        //Get instance of ParameterMap Class
        let paramInstance = new parameter_map_1.ParameterMap();
        /* Possible parameters for Get Users operation */
        await paramInstance.add(users_operations_1.GetUsersParam.TYPE, "ActiveUsers");
        await paramInstance.add(users_operations_1.GetUsersParam.PAGE, 1);
        await paramInstance.add(users_operations_1.GetUsersParam.PER_PAGE, 200);
        //Get instance of HeaderMap Class
        let headerInstance = new header_map_1.HeaderMap();
        /* Possible headers for Get Users operation */
        await headerInstance.add(users_operations_1.GetUsersHeader.IF_MODIFIED_SINCE, new Date("2019-07-07T10:00:00+05:30"));
    ...
    static async getuser(userId) {
        ...
        await headerInstance.add(users_operations_1.GetUserHeader.IF_MODIFIED_SINCE, new Date("2019-12-12T12:12:12+05:30"));
    ...
    static async createUser() {
        ...
        let request = new request_wrapper_1.RequestWrapper();
        //Array to hold User instances
        let userArray = [];
        //Get instance of User Class
        let user = new user_1.User();
