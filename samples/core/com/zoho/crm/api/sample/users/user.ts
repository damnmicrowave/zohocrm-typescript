import { GetUserHeader, GetUsersParam, GetUsersHeader, UsersOperations } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/users_operations"
import { ActionHandler } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/action_handler"
import { ResponseHandler } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/response_handler"
import { SuccessResponse } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/success_response"
import { APIException } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/api_exception"
import { ResponseWrapper } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/response_wrapper"
import { ActionWrapper } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/action_wrapper"
...
import { CustomizeInfo } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/customize_info";
import { Role } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/roles/role";
import { Theme } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/theme";
import { TabTheme } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/tab_theme";
import { Profile } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/profiles/profile";
import { Territory } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/territory";
import { Info } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/info";
import { BodyWrapper } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/body_wrapper"
import { ActionResponse } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/action_response"
import { RequestWrapper } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/users/request_wrapper"
...
export class Users {
	...
	public static async getUsers() {
		...
		let usersOperations: UsersOperations = new UsersOperations();
		...
		let response: APIResponse<ResponseHandler> = await usersOperations.getUsers(paramInstance, headerInstance);
		...
		if (response != null) {
			...
			if (responseObject != null) {
				...
				if (responseObject instanceof ResponseWrapper) {
					...
					let users: User[] = responseObject.getUsers();
					...
					users.forEach(user => {
						...
						let customizeInfo: CustomizeInfo = user.getCustomizeInfo();
						...
						let modifiedBy: User = user.getModifiedBy();
						...
						let theme: Theme = user.getTheme();

						//Check if theme is not null
						if (theme != null) {
							// Get the TabTheme instance of Theme
							let normalTab: TabTheme = theme.getNormalTab();
							...
							// Get the TabTheme instance of Theme
							let selectedTab: TabTheme = theme.getSelectedTab();
						...
						let reportingTo: User = user.getReportingTo();
						...
						let profile: Profile = user.getProfile();
						...
						let createdBy: User = user.getCreatedBy();
						...
						let territories: Territory[] = user.getTerritories();
	...
	public static async getuser(userId: bigint) {
		...
		let response: APIResponse<ResponseHandler> = await usersOperations.getUser(userId, headerInstance);
	...
	public static async updateUsers() {
		...
		role.setId(BigInt("34770610026008"));
		...
		let response: APIResponse<ActionHandler> = await usersOperations.updateUsers(request);
		...
		if (response != null) {
			...
			if (responseObject != null) {
				...
				if (responseObject instanceof ActionWrapper) {
					...
					let actionResponses: ActionResponse[] = responseObject.getUsers();
	...
	public static async updateUser(userId: bigint) {
		...
		let response: APIResponse<ActionHandler> = await usersOperations.updateUser(userId, request);
	...
	public static async deleteUser(userId: bigint) {
		...
		let response: APIResponse<ActionHandler> = await usersOperations.deleteUser(userId);
	...
	public static async createUser() {
		...
		let request: RequestWrapper = new RequestWrapper();
		...
		profile.setId(BigInt("34770610026014"));
		...
		let response: APIResponse<ActionHandler> = await usersOperations.createUser(request);
