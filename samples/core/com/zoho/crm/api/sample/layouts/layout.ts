...
import { LayoutsOperations } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/layouts_operations"
import { Properties } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/properties";
import { ResponseHandler } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/response_handler";
import { ResponseWrapper } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/response_wrapper";
import { APIException } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/api_exception";
import { Section } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/section";
...
export class Layouts {
    ...
    public static async getLayouts(moduleAPIName: string) {
        ...
        let layoutsOperations: LayoutsOperations = new LayoutsOperations(moduleAPIName);

        //Call getLayouts method
        let response: APIResponse<ResponseHandler> = await layoutsOperations.getLayouts();
        ...
        if (response != null) {
            ...
            if (responseObject != null) {
                ...
                if (responseObject instanceof ResponseWrapper) {
                    ...
                    let layouts: Layout[] = responseObject.getLayouts();
                    ...
                    layouts.forEach(layout => {
                        ...
                        let createdFor: User = layout.getCreatedFor();
                        ...
                        let modifiedBy: User = layout.getModifiedBy();
                        ...
                        let profiles: Profile[] = layout.getProfiles();
                        ...
                        let createdBy: User = layout.getCreatedBy();
                        ...
                        let sections: Section[] = layout.getSections();
                        ...
                        if (sections != null) {
                            sections.forEach(section => {
                                ...
                                let fields: Field[] = section.getFields();
                                ...
                                let properties: Properties = section.getProperties();
                                ...
                                if (properties != null) {
                                    ...
                                    let tooltip: ToolTip = properties.getTooltip();
    ...
    public static async getLayout(moduleAPIName: string, layoutId: bigint) {
        ...
        let response: APIResponse<ResponseHandler> = await layoutsOperations.getLayout(layoutId);
    ...
    private static async printField(field: Field) {
