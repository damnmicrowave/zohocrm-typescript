...
const layouts_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/layouts_operations");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/response_wrapper");
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/layouts/api_exception");
class Layouts {
    /**
     * <h3> Get Layouts </h3>
    ...
    static async getLayouts(moduleAPIName) {
        ...
        let layoutsOperations = new layouts_operations_1.LayoutsOperations(moduleAPIName);
