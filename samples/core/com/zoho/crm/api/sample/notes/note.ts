import { DeleteNotesParam, GetNoteHeader, GetNoteParam, GetNotesHeader, GetNotesParam, NotesOperations } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/notes_operations"
import { Note } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/note"
import { ResponseHandler } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/response_handler"
import { ResponseWrapper } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/response_wrapper"
import { ActionWrapper } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/action_wrapper"
import { APIException } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/api_exception"
import { SuccessResponse } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/success_response"
...
import { Info } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/info"
import { BodyWrapper } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/body_wrapper"
import { ActionHandler } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/action_handler"
import { ActionResponse } from "@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/action_response"
...
export class Notes {
    ...
    public static async getNotes() {
        ...
        let notesOperations: NotesOperations = new NotesOperations();
        ...
        let response: APIResponse<ResponseHandler> = await notesOperations.getNotes(paramInstance, headerInstance);
        ...
        if (response != null) {
            ...
            if (responseObject != null) {
                ...
                if (responseObject instanceof ResponseWrapper) {
                    ...
                    let notes: Note[] = responseObject.getData();

                    notes.forEach(note => {

                        //Get the owner User instance of each Note
                        let owner: User = note.getOwner();
                        ...
                        let attachments: Attachment[] = note.getAttachments();
                        ...
                        let parentId: Record = note.getParentId();
                        ...
                        let modifiedBy: User = note.getModifiedBy();
                        ...
                        let createdBy: User = note.getCreatedBy();
    ...
    public static async getNote(noteId: bigint) {
        ...
        // await paramInstance.add(GetNoteParam.FIELDS, "id,Note_Content")

        //Get instance of HeaderMap Class
        let headerInstance: HeaderMap = new HeaderMap();

        /* Possible headers for Get Note */
        // await headerInstance.add(GetNoteHeader.IF_MODIFIED_SINCE, new Date());

        //Call getNote method that takes noteId as parameter
        let response: APIResponse<ResponseHandler> = await notesOperations.getNote(noteId, paramInstance, headerInstance);
    ...
    private static async printAttachment(attachment: Attachment) {
    ...
    public static async createNotes() {
        ...
        for (let index = 0; index < 5; index++) {
            ...
            let parentRecord: Record = new Record();

            //Set ID of the Record
            parentRecord.setId(BigInt("347706110898001"));
        ...
        let response: APIResponse<ActionHandler> = await notesOperations.createNotes(request);
    ...
    public static async updateNotes() {
        ...
        //Set ID to Note
        note.setId(BigInt("347706110928004"));
        ...
        //Set ID to Note
        note.setId(BigInt("347706110928005"));
        ...
        let response: APIResponse<ActionHandler> = await notesOperations.updateNotes(request);
    ...
    public static async updateNote(noteId: bigint) {
        ...
        let response: APIResponse<ActionHandler> = await notesOperations.updateNote(noteId, request);
    ...
    public static async deleteNotes(noteIds: bigint[]) {
        ...
        let response: APIResponse<ActionHandler> = await notesOperations.deleteNotes(paramInstance);
    ...
    public static async deleteNote(noteId: bigint) {
        ...
        let response: APIResponse<ActionHandler> = await notesOperations.deleteNote(noteId);
