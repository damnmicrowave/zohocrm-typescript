...
const notes_operations_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/notes_operations");
const note_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/note");
const response_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/response_wrapper");
const action_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/action_wrapper");
const api_exception_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/api_exception");
const success_response_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/success_response");
...
const body_wrapper_1 = require("@zohocrm/typescript-sdk-2.0/core/com/zoho/crm/api/notes/body_wrapper");
class Notes {
    /**
     * <h3> Get Notes </h3>
    ...
    static async getNotes() {
        ...
        let notesOperations = new notes_operations_1.NotesOperations();
        //Get instance of ParameterMap Class
        let paramInstance = new parameter_map_1.ParameterMap();
        /* Possible parameters for Get Notes */
        await paramInstance.add(notes_operations_1.GetNotesParam.PAGE, 1);
    ...
    static async createNotes() {
        ...
        for (let index = 0; index < 5; index++) {
            ...
            let parentRecord = new record_1.Record();
    ...
    static async deleteNotes(noteIds) {
        ...
        for (let noteId of noteIds) {
            await paramInstance.add(notes_operations_1.DeleteNotesParam.IDS, noteId);
        }
